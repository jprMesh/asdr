...
%UHD:
UHD (or USRP Hardware Driver) is a set of C++ libraries created by Ettus Research to allow for control of their USRP SDR platform within C++ programs. %\cite{http://files.ettus.com/manual/}
