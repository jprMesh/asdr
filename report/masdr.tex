...
\begin{document}
	...
	%
	\begin{abstract}
		The frontiers of technology are rapidly expanding and as a result, human capabilities even more so. This project focuses on incorporating two new technologies, drones and software defined radios, to detect and localize relevant wireless signals with increased maneuverability. The objective lies in building a platform for wireless signal mapping, search and rescue purposes, and future development.
	\end{abstract}
	...
	\end{center}
	John Peck, Professor Alexander Wyglinski, Cathy(?), Bill Appleyard(??), Whoever we talked to about the solo.
